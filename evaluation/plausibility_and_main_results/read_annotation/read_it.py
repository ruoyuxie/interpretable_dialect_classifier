...
def experiment_2 (original_tsv_file, annotator_folder):
    ...
    for original_file in orginal_files:
        ...
        if file_name == "loo":
            ...
            experiment_name = "Salient tokens (three methods extracted from selfExp)"
        ...
        for annotator in annotators:
            ...
            # if left and right words are appeared in cleaned_annotator_words,
            ...
            print("\ny words / Italian:")
            print(f"Total number of words in y: {len(left_words)}")
            ...
            print("--------------------")
            print("x words / Dialect:")
            print(f"Total number of words in x: {len(right_words)}")
            ...
            # print(f"Number of class 0 words: {len(correct_left_words)} out of {len(left_words)}")
            # print(f"Number of class 1 words: {len(correct_right_words)} out of {len(right_words)}")
            # print(f"Score in class 0: {len(correct_left_words)/len(left_words)}")
            # print(f"Score in class 1: {len(correct_right_words)/len(right_words)}")
        ...
        if "cn-tw" in original_file:
            ...
            print(f"Number of class 0 words: {len(final_left_words)} out of {len(left_words)}")
            print(f"Number of class 1 words: {len(final_right_words)} out of {len(right_words)}")

            # print(f"Score in class 0: {len(final_left_words)/len(left_words)}")
            # print(f"Score in class 1: {len(final_right_words)/len(right_words)}")
